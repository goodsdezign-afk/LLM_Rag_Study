...
from src.doc_processor.doc_processor import SUPPORTED_EXT
import asyncio
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                file_upload = gr.File(label=f"Drop files here (Supported: {', '.join(SUPPORTED_EXT)})",
                                      file_types=list(SUPPORTED_EXT))
